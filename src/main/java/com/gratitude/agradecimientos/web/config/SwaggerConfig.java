package com.gratitude.agradecimientos.web.config;
...
public class SwaggerConfig {
    ...
    public Docket api(){
        return new Docket(DocumentationType.SWAGGER_2)
                .select() //Selecciono
                .apis(RequestHandlerSelectors.basePackage("ccom.gratitude.agradecimientos.web.controller")) //Pongo la ruta del paquete
                .build(); // construyo
    }
}
